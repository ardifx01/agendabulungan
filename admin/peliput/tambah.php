...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Simpan ke database
    $stmt = $pdo->prepare("INSERT INTO peliput (nama, jabatan, unit_kerja)
    ...
    set_flash('success', 'Data peliput berhasil ditambahkan.');
    redirect('index.php');
}
?>
...
<main class="p-6 ml-64">
    <h1 class="text-2xl font-bold mb-4">Tambah Peliput</h1>
