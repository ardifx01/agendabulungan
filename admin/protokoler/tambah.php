...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO protokoler (nama, jabatan, unit_kerja)
                           VALUES (:nama, :jabatan, :unit_kerja)");
    $stmt->execute([
        'nama'       => $nama,
        'jabatan'    => $jabatan,
    ...
    set_flash('success', 'Data protokoler berhasil ditambahkan.');
    redirect('index.php');
}
?>
...
<main class="p-6 ml-64">
    <h1 class="text-2xl font-bold mb-4">Tambah Protokoler</h1>
